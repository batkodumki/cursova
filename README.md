...
3. **Парні порівняння**
   - Для кожної пари альтернатив:
     - Оберіть шкалу (Ординальна, Сааті-5, Сааті-9, Збалансована, Степенева)
     - Використовуйте слайдер для вибору градації
     - Лінгвістичні фрази допоможуть зробити вибір
     - Можна уточнити ступінь переваги (збільшити детальність шкали)
...
### Приклад з різними шкалами:

Спробуйте використовувати різні шкали для різних порівнянь:
- **Ординальна (2)**: коли впевнені тільки в напрямку переваги
- **Сааті-5**: для помірної деталізації
- **Сааті-9**: для максимальної точності
- **Збалансована/Степенева**: для специфічних випадків
